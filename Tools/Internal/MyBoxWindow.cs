	...
	public class MyBoxWindow : EditorWindow
	{
		...
		private void OnGUI()
		{
			...
			using (new EditorGUILayout.HorizontalScope())
			{
				...
				if (GUILayout.Button(MyGUI.EditorIcons.Help, EditorStyles.label, GUILayout.Height(18))) Application.OpenURL("https://github.com/hnguyen094/MyBox/wiki/Tools-and-Features#iprepare");
				GUILayout.FlexibleSpace();
			}
			...
			using (new EditorGUILayout.HorizontalScope())
			{
				...
				if (GUILayout.Button("  How to Update ↗", _buttonStyle, GUILayout.Width(buttonWidth), GUILayout.Height(buttonHeight)))
					Application.OpenURL("https://github.com/hnguyen094/MyBox/wiki/Installation");
